public class BuildParameters
{
    ...
    public FilePath[] GetBuildArtifacts(IEnumerable<string> projectNames)
    {
    ...
    public FilePath[] GetBuildArtifacts(params string[] projectNames)
    {
        ...
        return projectNames.Select(projectName =>
        {
